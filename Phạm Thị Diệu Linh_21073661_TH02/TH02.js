...
function bai1(){
    ...
    result.innerHTML = "Nghiệm x = " + (numbB/numbA)*-1;
...
window.onload = function() {
    ...
    var signupButton = document.getElementsByTagName('button')[1];
    var forgotPasswordLink = document.getElementsByTagName('a')[0];
